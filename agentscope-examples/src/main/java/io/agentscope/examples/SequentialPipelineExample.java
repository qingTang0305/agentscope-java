...
public class SequentialPipelineExample {
    ...
    /**
     * Create a translator agent that translates English to Chinese.
     *
     * @param apiKey DashScope API key
     * @return Configured translator agent
     */
    ...
    /**
     * Create a summarizer agent that generates concise summaries.
     *
     * @param apiKey DashScope API key
     * @return Configured summarizer agent
     */
    ...
    /**
     * Create a sentiment analyzer agent that analyzes emotional tone.
     *
     * @param apiKey DashScope API key
     * @return Configured sentiment analyzer agent
     */
